...
| Page | Focus |
|---|---|
| **Fidelity International — Product Owner, Multi-Asset** | Multi-Asset, Systematic & Solutions Value Stream, Hong Kong — the steepest domain stretch in this folder. Screening-call intel on the 3-round interview process, the real difference between buy-side asset-management front office and a retail trading platform, a systematic-equities primer, vocabulary tables (buy-side/sell-side, exposure lifecycle, compliance breaches, risk Greeks), a day-to-day stakeholder workflow diagram, SAFe/Agile Release Train vocabulary vs. Scrum certs, the FIL-vs-Fidelity-Investments mix-up, an honest fit map, standardised four-beat self-intro, blended domain-and-technical Q&A, questions to ask. |
